...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frameLambda = self.centralwidget.findChild(type(self.centralwidget), "frameLambda")
        ...
        self.lblLambda = self.centralwidget.findChild(type(self.centralwidget), "lblLambda")
        ...
        self.lambdaThreshold = self.centralwidget.findChild(type(self.centralwidget), "lambdaThreshold")
        self.lambdaSigma = self.centralwidget.findChild(type(self.centralwidget), "lambdaSigma")
        self.lambdaWindow = self.centralwidget.findChild(type(self.centralwidget), "lambdaWindow")
        ...
        self.btnApplyLambda = self.centralwidget.findChild(type(self.centralwidget), "btnApplyLambda")
